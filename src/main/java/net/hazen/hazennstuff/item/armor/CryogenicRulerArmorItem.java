...
public class CryogenicRulerArmorItem extends ImbuableModArmorItem {
    public CryogenicRulerArmorItem(Type type, Properties settings) {
        // Add in your armor tier + additional attributes for your item
        super(ModArmorMaterials.CRYOGENIC_RULER_MATERIAL, type, settings,
    ...
    private void evaluateArmorEffects(Player player) {
        if (!player.hasEffect(ModEffects.SUB_ZERO_EFFECT)) {
            player.addEffect(new MobEffectInstance(ModEffects.SUB_ZERO_EFFECT, 200, 0, false, false, true));
        }
    }
