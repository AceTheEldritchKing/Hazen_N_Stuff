...
public class SoulFlameArmorRenderer extends GeoArmorRenderer<SoulFlameArmorItem> {
    public SoulFlameArmorRenderer() {
        super(new SoulFlameArmorModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(SoulFlameArmorRenderer.this));
    }
