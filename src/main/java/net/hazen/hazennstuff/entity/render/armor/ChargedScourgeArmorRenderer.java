...
public class ChargedScourgeArmorRenderer extends GeoArmorRenderer<ChargedScourgeArmorItem> {
    public ChargedScourgeArmorRenderer() {
        super(new ChargedScourgeArmorModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(ChargedScourgeArmorRenderer.this));
    }
