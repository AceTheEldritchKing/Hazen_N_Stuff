...
import net.hazen.hazennstuff.entity.armor.DarkRitualTemplarArmorModel;
import net.hazen.hazennstuff.item.armor.DarkRitualTemplarArmorItem;
import net.minecraft.client.model.HumanoidModel;
import net.minecraft.client.model.geom.ModelPart;
import net.minecraft.world.entity.EquipmentSlot;

public class DarkRitualTemplarArmorRenderer extends GeoArmorRenderer<DarkRitualTemplarArmorItem> {
    public DarkRitualTemplarArmorRenderer() {
        super(new DarkRitualTemplarArmorModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(DarkRitualTemplarArmorRenderer.this));
    }
