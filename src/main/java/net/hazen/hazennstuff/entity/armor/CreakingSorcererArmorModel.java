...
public class CreakingSorcererArmorModel extends DefaultedEntityGeoModel<CreakingSorcererArmorItem> {
    ...
    public ResourceLocation getTextureResource(CreakingSorcererArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HazenNStuff.MOD_ID, "textures/models/armor/creaking_armor.png");
    }
